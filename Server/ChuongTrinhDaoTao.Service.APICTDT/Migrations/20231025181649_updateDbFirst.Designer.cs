...
namespace ChuongTrinhDaoTao.Service.APICTDT.Migrations
{
    ...
    [Migration("20231025181649_updateDbFirst")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChuongTrinhDaoTao.Service.APICTDT.Models.BlockOfKnowledge_Course", b =>
                {
                    ...
                    b.HasKey("BlockOfKnowledgeId", "CourseId");
            ...
            modelBuilder.Entity("ChuongTrinhDaoTao.Service.APICTDT.Models.EducationProgram", b =>
                {
                    b.Property<int>("EducationProgramId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CohortId", "MajorId")
                        .IsUnique()
                        .HasFilter("[CohortId] IS NOT NULL AND [MajorId] IS NOT NULL");

                    b.ToTable("EducationProgram", (string)null);
                });

            modelBuilder.Entity("ChuongTrinhDaoTao.Service.APICTDT.Models.Education_BOK", b =>
                {
                    b.Property<int>("BlockOfKnowledgeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("BlockOfKnowledgeId", "EducationProgramId");

                    b.HasIndex("EducationProgramId");

                    b.ToTable("Education_BOK", (string)null);
                });
            ...
            modelBuilder.Entity("ChuongTrinhDaoTao.Service.APICTDT.Models.EducationProgram", b =>
                {
                    b.HasOne("ChuongTrinhDaoTao.Service.APICTDT.Models.Cohort_Major", "Cohort_Major")
                        .WithOne("EducationProgram")
                        .HasForeignKey("ChuongTrinhDaoTao.Service.APICTDT.Models.EducationProgram", "CohortId", "MajorId");
            ...
            modelBuilder.Entity("ChuongTrinhDaoTao.Service.APICTDT.Models.Education_BOK", b =>
                {
                    b.HasOne("ChuongTrinhDaoTao.Service.APICTDT.Models.BlockOfKnowledge", "BlockOfKnowledge")
                        .WithMany("BOKEducations")
                        .HasForeignKey("BlockOfKnowledgeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChuongTrinhDaoTao.Service.APICTDT.Models.EducationProgram", "EducationProgram")
                        .WithMany("Education_BOK")
